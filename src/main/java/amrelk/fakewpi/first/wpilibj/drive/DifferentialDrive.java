...
package amrelk.fakewpi.first.wpilibj.drive;

import amrelk.fakewpi.first.wpilibj.SpeedController;
import amrelk.fakewpi.first.wpilibj.SpeedControllerGroup;
 ...
 * six motor drivetrains, construct and pass in {@link amrelk.fakewpi.first.wpilibj.SpeedControllerGroup}
 ...
 * positive.
 *
 * <p>Inputs smaller then {@value amrelk.fakewpi.first.wpilibj.drive.RobotDriveBase#kDefaultDeadband} will
 ...
 * {@link amrelk.fakewpi.first.wpilibj.RobotDrive#tankDrive(double, double)} if a deadband of 0 is used.
 * <br>{@link #arcadeDrive(double, double)} is equivalent to
 * {@link amrelk.fakewpi.first.wpilibj.RobotDrive#arcadeDrive(double, double)} if a deadband of 0 is used
 ...
 * {@link amrelk.fakewpi.first.wpilibj.RobotDrive#drive(double, double)} with the addition of a quick turn
