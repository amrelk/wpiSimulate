...
import amrelk.fakewpi.first.wpilibj.SendableBase;
import amrelk.fakewpi.first.wpilibj.buttons.Trigger.ButtonScheduler;
...
public final class Scheduler extends SendableBase {
  ...
  /**
   * A list of all {@link amrelk.fakewpi.first.wpilibj.buttons.Trigger.ButtonScheduler Buttons}. It is
   * created lazily.
   */
  @SuppressWarnings("PMD.LooseCoupling")
