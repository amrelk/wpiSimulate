...
package amrelk.fakewpi.first.wpilibj.livewindow;

import java.util.HashMap;
import java.util.Map;

import amrelk.fakewpi.first.networktables.NetworkTable;
import amrelk.fakewpi.first.networktables.NetworkTableEntry;
import amrelk.fakewpi.first.networktables.NetworkTableInstance;
import amrelk.fakewpi.first.wpilibj.Sendable;
import amrelk.fakewpi.first.wpilibj.command.Scheduler;
import amrelk.fakewpi.first.wpilibj.smartdashboard.SendableBuilderImpl;
...
public class LiveWindow {
   ...
   * @deprecated Use {@link amrelk.fakewpi.first.wpilibj.SendableBase#setName(String, int)} instead.
   */
  @Deprecated
   ...
   * @param channel      The channel number the device is plugged into (usually PWM)
   * @param component    The reference to the object being added
   * @deprecated Use {@link amrelk.fakewpi.first.wpilibj.SendableBase#setName(String, int, int)} instead.
   */
  @Deprecated
