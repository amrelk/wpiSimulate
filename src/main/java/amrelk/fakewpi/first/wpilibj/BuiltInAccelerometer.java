...
import amrelk.fakewpi.first.wpilibj.hal.AccelerometerJNI;
import amrelk.fakewpi.first.wpilibj.hal.FRCNetComm.tResourceType;
import amrelk.fakewpi.first.wpilibj.hal.HAL;
import amrelk.fakewpi.first.wpilibj.interfaces.Accelerometer;
import amrelk.fakewpi.first.wpilibj.sim.AccelerometerSim;
